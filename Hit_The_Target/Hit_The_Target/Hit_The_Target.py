...
if (turtle.xcor() >= TARGET_LLEFT_X and
    ...
    print('You missed the target. Try using less of an angle and more force.')
elif (angle < 68 and force < 9):
    print('You missed the target. Try using more of an angle and a little bit more force.')
elif (angle == 68 and force < 9):
